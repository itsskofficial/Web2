...
function SinglePost() {
	...
	const loopThroughPostsUp = () => {
		...
		const nextPostId =
			dataPost.getPostById.otherPostIds[currentPostIdIndex];
		...
		>
			<div className="lg:w-[calc(100%-540px)] h-full relative">
				...
				<img
					...
					src="/src/assets/images/videofun-logo-small.png"
				/>
			...
			>
					...
					<div className="flex items-center">
						...
						<div className="ml-3 pt-0.5">
							...
							<div className="text-[13px] -mt-5 font-light">
								...
								<span className="relative top-[6px] text-[30px] pr-0.5">
									•
								</span>
				...
				<div className="flex items-center px-8 mt-8">
					<div className="pb-4 text-center flex items-center">
						<button
							disabled={
								dataPost?.getPostById?.userId === loggedInUserId
							}
							className="rounded-full bg-gray-200 p-2 cursor-pointer"
							onClick={() =>
								isLiked ? handleRemoveLike() : handleLikePost()
							}
						>
							<AiFillHeart
								size="25"
