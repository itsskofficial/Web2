			...
			<div className="lg:w-full w-[55px] mx-auto">
				...
				<div className="lg:block hidden text-[11px] text-gray-500">
					<div className="pt-4 px-2">
						About Newsroom VideoFun Shop Contact Careers
					</div>
					<div className="pt-4 px-2">
						VideoFun for Good Advertise Developers Transperancy
						VideoFun Rewards VideoFun Browse VideoFun
					</div>
					<div className="pt-4 px-2">2023 VideoFun</div>
