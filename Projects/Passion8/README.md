...
<div align="center">
  ...
  <h3 align="center">Passion8</h3>

  <p align="center">
    A landing page template for Web3 startups
    <br />
...
Every startup needs a landing page. And they pay high amounts of money to get it done. Instead why not use a template. Almost all Web3 startups have the same baseline that is something related to a cryptocurrency. So I created this template with all the required needs for a clean and attractive landing page
...
You can use this template to build your own landing pages for a startup or any other purpose. Don't forget to check the lisence usage.
