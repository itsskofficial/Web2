          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-dark shadow-2xl ring-1 ring-white ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                          ...
                          {({ active }) => (
                            <a
                              ...
                              className={classNames(
                                option.current ? 'font-medium text-white-900' : 'text-white-500',
                                active ? 'bg-white-100' : '',
                    ...
                    {({ open }) => (
                      <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-white-400 hover:text-white-500">
                            <span className="font-medium text-white-900">{section.name}</span>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
