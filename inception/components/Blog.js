    ...
    return (
      ...
      <div>
        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment}>
          <Dialog as="div" className="relative z-99 lg:hidden" onClose={setMobileFiltersOpen}>
            <Transition.Child
              as={Fragment}
            ...
            <div className="fixed inset-0 z-99 flex">
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl z-99">
                  <div className="flex items-center justify-between px-4">
                    <h2 className="text-lg font-medium text-white-900">Filters</h2>
                    <button
                      type="button"
                      className="-mr-2 flex h-10 w-10 items-center justify-center rounded-md bg-dark p-2 text-white-400"
                  ...
                  <form className="mt-4 border-t border-white-200">
                    ...
                    {filters.map((section) => (
                      <Disclosure as="div" key={section.id} className="border-t border-white-200 px-4 py-6 z-99">
                        {({ open }) => (
                          <>
                            <h3 className="-mx-2 -my-3 flow-root">
                              <Disclosure.Button className="flex w-full items-center justify-between bg-dark px-2 py-3 text-white-400 hover:text-white-500">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-white-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-white-900">Latest From The Blog</h1>
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-dark ring-opacity-5 focus:outline-none">
                    <div className="py-1">
              ...
              <button type="button" className="-m-2 ml-5 p-2 text-white-400 hover:text-white-500 sm:ml-7">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                {filters.map((section) => (
                  <Disclosure as="div" key={section.id} className="border-b border-white-200 py-6">
                    {({ open }) => (
                      <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="flex w-full items-center justify-between bg-dark py-3 text-sm text-white-400 hover:text-white-500">
                            <span className="font-medium text-white-900">{section.name}</span>
                            <span className="ml-6 flex items-center">
                              {open ? (
                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
              ...
              {/* Product grid */}
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 pt-10  lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
