    ...
    return (
      ...
      <div>
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl z-99">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    {filters.map((section) => (
                      <Disclosure as="div" key={section.id} className="border-t border-gray-200 px-4 py-6 z-99">
                        {({ open }) => (
                          <>
                            <h3 className="-mx-2 -my-3 flow-root">
                              <Disclosure.Button className="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-900 hover:text-gray-700">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {posts.map((post) => (
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between sm:mt-30">
