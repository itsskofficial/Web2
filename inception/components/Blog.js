              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-dark py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-white-200">
                    ...
                    <ul role="list" className="px-2 py-3 font-medium text-white-900">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                <h3 className="sr-only">Categories</h3>
                <ul role="list" className="space-y-4 border-b border-white-200 pb-6 text-sm font-medium text-white-900">
                  {subCategories.map((category) => (
                    <li key={category.name}>
              ...
              {/* Product grid */}
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 pt-10 sm:mt-5 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
